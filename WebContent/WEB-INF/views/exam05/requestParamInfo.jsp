...
<div class="card m-2">
   ...
   <div class="card-body">
      <a href="ParamController?pageNo=5&kind=freeboard&writer=winter&hobby=movie&hobby=music" class="btn btn-info btn-sm">GET 방식으로 전달</a>
      <hr />
      <form method="post" action="ParamController" novalidate="novalidate">
